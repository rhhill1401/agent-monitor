    ...
    <div style={styles.container}>
      ...
      {(() => {
        const goalDefinitions = [
          ...
          { key: 'xFollowers', label: '📈 New X Followers', target: 16, current: dailyGoals.xFollowers?.current || dailyGoals.newXFollowers?.current || 3, description: 'Net new followers on @RomesStorybook today', actions: ['Post native video content', 'Engage with target accounts', 'Reply to trending topics', 'Use #TrapNursery'] },
          { key: 'ytSubs', label: '🔔 New YouTube Subs', target: 17, current: dailyGoals.ytSubs?.current || dailyGoals.newYTSubs?.current || 8, description: 'Net new subscribers today (17/day for 300 by Mar 1)', actions: ['Post Shorts with strong hooks', 'Dance Party at 7 PM', 'Optimize titles per SEO guide', 'Cross-promote from X'] },
